...
export default function EmptyStatePanel({
  ...
  return (
    <div className="rounded-[var(--sa-radius-md)] border border-[hsl(var(--sa-border)/0.35)] bg-[hsl(var(--sa-surface-1)/0.55)] px-5 py-8 text-center">
      ...
      {actionLabel && onAction ? (
        <Button
          type="button"
          onClick={onAction}
          className="sa-focus-ring mt-4 bg-[hsl(var(--sa-accent))] text-[hsl(var(--sa-accent-foreground))] hover:bg-[hsl(var(--sa-accent)/0.9)]"
          {...actionAttrs}
        >
          {actionLabel}
        </Button>
